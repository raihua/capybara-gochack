...
def main():
    file_path = 'gdp-us.csv'
    start_date = '2023-01-01'
    end_date = '2050-01-01'
    
    data = load_data(file_path)
    model_fit = train_arima_model(data['GDP (current US$)'])
